...
def send():
    if textReceipt.get(1.0,END)=='\n':
        ...
        label=Label(root2,image=logoImage,bg='light blue')
        label.pack(pady=5)

        numberLabel=Label(root2,text='Mobile Number',font=('arial',18,'bold underline'),bg='light blue',fg='white')
        numberLabel.pack(pady=5)

        numberfield=Entry(root2,font=('helvetica',22,'bold'),bd=3,width=24)
        numberfield.pack(pady=5)

        billLabel = Label(root2, text='Bill Details', font=('arial', 18, 'bold underline'), bg='light blue', fg='white')
        ...
        sendButton=Button(root2,text='SEND',font=('arial',19,'bold'),bg='white',fg='light blue',bd=7,relief=GROOVE
                          ,command=send_msg)
...
calculatorFrame=Frame(rightFrame,bd=1,relief=RIDGE,bg='white')
calculatorFrame.pack()

recieptFrame=Frame(rightFrame,bd=4,relief=RIDGE,bg='white')
recieptFrame.pack()

buttonFrame=Frame(rightFrame,bd=3,relief=RIDGE,bg='white')
buttonFrame.pack()
...
labelCostofFood=Label(costFrame,text='Cost of Food',font=('arial',16,'bold'),bg='firebrick4',fg='black')
...
labelCostofDrinks=Label(costFrame,text='Cost of Drinks',font=('arial',16,'bold'),bg='firebrick4',fg='black')
...
labelCostofCakes=Label(costFrame,text='Cost of Cakes',font=('arial',16,'bold'),bg='firebrick4',fg='black')
...
labelSubTotal=Label(costFrame,text='Sub Total',font=('arial',16,'bold'),bg='firebrick4',fg='black')
labelSubTotal.grid(row=0,column=2)

textSubTotal=Entry(costFrame,font=('arial',16,'bold'),bd=6,width=14,state='readonly',textvariable=subtotalvar)
textSubTotal.grid(row=0,column=3,padx=41)

labelServiceTax=Label(costFrame,text='Service Tax',font=('arial',16,'bold'),bg='firebrick4',fg='black')
...
labelTotalCost=Label(costFrame,text='Total Cost',font=('arial',16,'bold'),bg='firebrick4',fg='black')
...
buttonTotal=Button(buttonFrame,text='Total',font=('arial',14,'bold'),fg='black',bg='white',bd=3,padx=5,
                   command=totalcost)
buttonTotal.grid(row=0,column=0)

buttonReceipt=Button(buttonFrame,text='Receipt',font=('arial',14,'bold'),fg='black',bg='white',bd=3,padx=5
                     ,command=receipt)
buttonReceipt.grid(row=0,column=1)

buttonSave=Button(buttonFrame,text='Save',font=('arial',14,'bold'),fg='black',bg='white',bd=3,padx=5
                  ,command=save)
buttonSave.grid(row=0,column=2)

buttonSend=Button(buttonFrame,text='Send',font=('arial',14,'bold'),fg='black',bg='white',bd=3,padx=5,command=send)
buttonSend.grid(row=0,column=3)

buttonReset=Button(buttonFrame,text='Reset',font=('arial',14,'bold'),fg='black',bg='white',bd=3,padx=5,
                   command=reset)
...
buttonAns=Button(calculatorFrame,text='Ans',font=('arial',16,'bold'),fg='black',bg='white',bd=6,width=6,
                 command=answer)
buttonAns.grid(row=4,column=0)

buttonClear=Button(calculatorFrame,text='Clear',font=('arial',16,'bold'),fg='black',bg='white',bd=6,width=6
                   ,command=clear)
...
buttonDiv=Button(calculatorFrame,text='/',font=('arial',16,'bold'),fg='black',bg='white',bd=6,width=6,
                 command=lambda:buttonClick('/'))
